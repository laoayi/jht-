  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="rightsInfos" border style="width: 100%; margin-top:30px">
        ...
        <el-table-column prop="departmentCreateTime" label="时间" ></el-table-column>
        <el-table-column prop="departmentId" label="部门编号 " ></el-table-column>
        <el-table-column prop="departmentLevel" label="部门等级 "></el-table-column>
        <el-table-column prop="departmentName" label="部门名称" ></el-table-column>
        <el-table-column prop="departmentStatus" label="状态" ></el-table-column>
        <el-table-column prop="departmentStatus" label="操作" width="300" >
...
export default {
  ...
  methods: {
    ...
    async getRightsInfos() {
      const { data: res } = await this.$http.get("/admin/rbac/department");
      if (res.code !== 200) {
        return this.$message.error(res.msg);
      }
